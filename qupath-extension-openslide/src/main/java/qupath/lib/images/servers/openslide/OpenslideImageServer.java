...
public class OpenslideImageServer extends AbstractTileableImageServer {
    ...
    private void initializeRemotely(String... args) throws IOException {
    ...
    private void initializeLocally(URI uri, String[] args) throws IOException {
...
//				args(args).
	...
	public BufferedImage readTile(TileRequest tileRequest) throws IOException {
		if (this.uri.getScheme().startsWith("http")) {
			return readTileRemotely(tileRequest);
		} else {
			return readTileLocally(tileRequest);
		}
	}

	private BufferedImage readTileLocally(TileRequest tileRequest) throws IOException {
