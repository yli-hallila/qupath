...
public class Browser extends Region {
    ...
    private String getHtml(String content, boolean body) {
        ...
        String CSS = "#content{word-wrap:break-word;box-sizing: content-box}blockquote,span[lang]{font-style:italic}figure,figure>figcaption{text-align:center}body{font-family:sans-serif,Arial,Verdana,\"Trebuchet MS\";font-size:12px;color:#333;background-color:#fff;margin:10px}blockquote{font-family:Georgia,Times,\"Times New Roman\",serif;padding:2px 0;border-style:solid;border-color:#ccc;border-width:0}a{color:#0782C1}dl,ol,ul{padding:0 40px}h1,h2,h3,h4,h5,h6{font-weight:400;line-height:1.2}hr{border:0;border-top:1px solid #ccc}img.left,img.right{border:1px solid #ccc;padding:5px}img.right{float:right;margin-left:15px}img.left{float:left;margin-right:15px}pre{white-space:pre-wrap;word-wrap:break-word;tab-size:4}.marker{background-color:#ff0}figure{outline:#ccc solid 1px;background:rgba(0,0,0,.05);padding:10px;margin:10px 20px;display:inline-block}a>img{padding:1px;margin:1px;border:none;outline:#0782C1 solid 1px}";
