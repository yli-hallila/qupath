...
public class ProjectBrowser implements ChangeListener<ImageData<BufferedImage>> {
	...
	private static StringProperty descriptionText = new SimpleStringProperty();
	...
	public static StringProperty descriptionTextProperty() {
		return descriptionText;
	}

	public static void setDescriptionText(String descriptionText) {
		ProjectBrowser.descriptionText.set(descriptionText);
	}
