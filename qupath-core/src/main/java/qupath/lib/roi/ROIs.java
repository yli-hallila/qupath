...
public class ROIs {
	...
	/**
	 * Create a arrow ROI with start and end coordinates.
	 *
	 * @param x
	 * @param y
	 * @param x2
	 ...
	 * @return
	 */
	public static ROI createArrowROI(double x, double y, double x2, double y2, ImagePlane plane) {
		return new ArrowROI(x, y, x2, y2, plane);
	}
	...
	/**
	 * Create a ROI representing a arrow with zero length.
	 *
	 * @param x
	 * @param y
	 * @param plane
